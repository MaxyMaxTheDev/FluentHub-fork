...
namespace FluentHub.Octokit.Models.v4
{
	...
	public class ContributionsCollection
	{
		...
		public List<CommitContributionsByRepository> CommitContributionsByRepository { get; set; } = default!;
		...
		/// </summary>
		public List<int> ContributionYears { get; set; } = default!;
		...
		public CreatedIssueContributionConnection IssueContributions { get; set; } = default!;
		...
		/// <param name="excludePopular">Should the user's most commented issue be excluded from the result.</param>
		/// <param name="maxRepositories">How many repositories should be included.</param>
		public List<IssueContributionsByRepository> IssueContributionsByRepository { get; set; } = default!;
		...
		/// <param name="orderBy">Ordering options for contributions returned from the connection.</param>
		public CreatedPullRequestContributionConnection PullRequestContributions { get; set; } = default!;
		...
		/// <param name="excludePopular">Should the user's most commented pull request be excluded from the result.</param>
		/// <param name="maxRepositories">How many repositories should be included.</param>
		public List<PullRequestContributionsByRepository> PullRequestContributionsByRepository { get; set; } = default!;
		...
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		/// <param name="orderBy">Ordering options for contributions returned from the connection.</param>
		public CreatedPullRequestReviewContributionConnection PullRequestReviewContributions { get; set; } = default!;

		/// <summary>
		/// Pull request review contributions made by the user, grouped by repository.
		/// </summary>
		/// <param name="maxRepositories">How many repositories should be included.</param>
		public List<PullRequestReviewContributionsByRepository> PullRequestReviewContributionsByRepository { get; set; } = default!;
		...
		/// <param name="orderBy">Ordering options for contributions returned from the connection.</param>
		public CreatedRepositoryContributionConnection RepositoryContributions { get; set; } = default!;
