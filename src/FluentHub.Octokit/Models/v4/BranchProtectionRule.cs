...
namespace FluentHub.Octokit.Models.v4
{
	...
	public class BranchProtectionRule
	{
		...
		public BranchProtectionRuleConflictConnection BranchProtectionRuleConflicts { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public BypassForcePushAllowanceConnection BypassForcePushAllowances { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public BypassPullRequestAllowanceConnection BypassPullRequestAllowances { get; set; } = default!;
		...
		public RefConnection MatchingRefs { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public PushAllowanceConnection PushAllowances { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public ReviewDismissalAllowanceConnection ReviewDismissalAllowances { get; set; } = default!;
	}
}
