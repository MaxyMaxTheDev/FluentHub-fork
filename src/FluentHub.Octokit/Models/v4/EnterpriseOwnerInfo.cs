...
namespace FluentHub.Octokit.Models.v4
{
	...
	public class EnterpriseOwnerInfo
	{
		...
		/// <param name="hasTwoFactorEnabled">Only return administrators with this two-factor authentication status. **Upcoming Change on 2025-04-01 UTC** **Description:** `hasTwoFactorEnabled` will be removed. Use `two_factor_method_security` instead. **Reason:** `has_two_factor_enabled` will be removed.</param>
		...
		/// </summary>
		public IpAllowListUserLevelEnforcementEnabledSettingValue IpAllowListUserLevelEnforcementEnabledSetting { get; set; }
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		/// <param name="hasTwoFactorEnabled">Only return outside collaborators with this two-factor authentication status. **Upcoming Change on 2025-04-01 UTC** **Description:** `hasTwoFactorEnabled` will be removed. Use `two_factor_method_security` instead. **Reason:** `has_two_factor_enabled` will be removed.</param>
		...
		/// </summary>
		public EnterpriseEnabledDisabledSettingValue RepositoryDeployKeySetting { get; set; }
		...
		/// </summary>
		public EnterpriseDisallowedMethodsSettingValue TwoFactorDisallowedMethodsSetting { get; set; }
