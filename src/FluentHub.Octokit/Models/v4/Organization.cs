...
namespace FluentHub.Octokit.Models.v4
{
	...
	public class Organization
	{
		...
		public OrganizationAuditEntryConnection AuditLog { get; set; } = default!;
		...
		public OrganizationEnterpriseOwnerConnection EnterpriseOwners { get; set; } = default!;
		...
		public MannequinConnection Mannequins { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public OrganizationMemberConnection MembersWithRole { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public UserConnection PendingMembers { get; set; } = default!;
		...
		/// </summary>
		/// <param name="propertyName">The name of the custom property to be returned.</param>
		...
		public RepositoryMigrationConnection RepositoryMigrations { get; set; } = default!;
		...
		/// <param name="includeParents">Include rulesets configured at higher levels that apply to this organization.</param>
