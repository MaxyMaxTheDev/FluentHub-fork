...
namespace FluentHub.Octokit.Models.v4
{
	...
	public class MarketplaceListing
	{
		...
		/// </summary>
		public string ConfigurationResourcePath { get; set; } = default!;
		...
		/// </summary>
		public string ExtendedDescriptionHTML { get; set; } = default!;
		...
		/// </summary>
		public string FullDescriptionHTML { get; set; } = default!;
		...
		/// </summary>
		public string HowItWorksHTML { get; set; } = default!;
		...
		/// </summary>
		public string NormalizedShortDescription { get; set; } = default!;
		...
		/// </summary>
		public MarketplaceCategory PrimaryCategory { get; set; } = default!;
