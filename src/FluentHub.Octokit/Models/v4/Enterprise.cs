...
namespace FluentHub.Octokit.Models.v4
{
	...
	public class Enterprise
	{
		...
		public EnterpriseTeamConnection EnterpriseTeams { get; set; } = default!;
		...
		public EnterpriseMemberConnection Members { get; set; } = default!;
		...
		/// </summary>
		public string ReadmeHTML { get; set; } = default!;
		...
		/// <param name="query">The search string to look for.</param>
		public UserNamespaceRepositoryConnection UserNamespaceRepositories { get; set; } = default!;
