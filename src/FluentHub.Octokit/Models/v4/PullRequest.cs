...
namespace FluentHub.Octokit.Models.v4
{
	...
	public class PullRequest
	{
		...
		/// </summary>
		public string BaseRefOid { get; set; } = default!;
		...
		/// </summary>
		public string ChecksResourcePath { get; set; } = default!;

		/// <summary>
		/// The HTTP URL for the checks of this pull request.
		/// </summary>
		public string ChecksUrl { get; set; } = default!;
		...
		/// </summary>
		public string RevertResourcePath { get; set; } = default!;

		/// <summary>
		/// The HTTP URL for reverting this pull request.
		/// </summary>
		public string RevertUrl { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public PullRequestReviewThreadConnection ReviewThreads { get; set; } = default!;
		...
		public SuggestedReviewerActorConnection SuggestedReviewerActors { get; set; } = default!;

		/// <summary>
		/// A list of reviewer suggestions based on commit history and past review comments.
		/// </summary>
		public List<SuggestedReviewer?> SuggestedReviewers { get; set; } = default!;
		...
		public string ViewerMergeBodyText { get; set; } = default!;

		/// <summary>
		/// The merge headline text for the viewer and method.
		/// </summary>
		/// <param name="mergeType">The merge method for the message.</param>
		public string ViewerMergeHeadlineText { get; set; } = default!;
