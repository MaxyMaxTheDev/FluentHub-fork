...
namespace FluentHub.Octokit.Models.v4
{
	...
	public class User
	{
		...
		/// </summary>
		public string BioHTML { get; set; } = default!;
		...
		/// </summary>
		public string CompanyHTML { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public GistCommentConnection GistComments { get; set; } = default!;
		...
		public GistConnection Gists { get; set; } = default!;
		...
		public IssueCommentConnection IssueComments { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public UserListConnection Lists { get; set; } = default!;
		...
		public List<string> OrganizationVerifiedDomainEmails { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public PublicKeyConnection PublicKeys { get; set; } = default!;
		...
		public RepositoryConnection RepositoriesContributedTo { get; set; } = default!;
		...
		/// <param name="last">Returns the last _n_ elements from the list.</param>
		/// <param name="before">Returns the elements in the list that come before the specified cursor.</param>
		public SocialAccountConnection SocialAccounts { get; set; } = default!;
		...
		/// </summary>
		public List<UserListSuggestion> SuggestedListNames { get; set; } = default!;
		...
		/// </summary>
		public UserViewType UserViewType { get; set; }
		...
		/// <param name="privacy">If non-null, filters repositories according to privacy. Internal repositories are considered private; consider using the visibility argument if only internal repositories are needed. Cannot be combined with the visibility argument.</param>
		/// <param name="visibility">If non-null, filters repositories according to visibility. Cannot be combined with the privacy argument.</param>
		public RepositoryConnection Watching { get; set; } = default!;
